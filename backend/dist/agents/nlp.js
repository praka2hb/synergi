...
exports.GENERAL_CLUSTER = exports.SEARCH_CLUSTER = exports.WEATHER_CLUSTER = exports.STOPWORDS = void 0;
exports.levenshtein = levenshtein;
exports.fuzzyMatch = fuzzyMatch;
exports.fuzzyMatchAny = fuzzyMatchAny;
exports.tokenize = tokenize;
exports.tokenizeForFuzzy = tokenizeForFuzzy;
exports.bigrams = bigrams;
exports.trigrams = trigrams;
exports.detectEmotion = detectEmotion;
exports.scoreIntent = scoreIntent;
exports.contextBoost = contextBoost;
 ...
 */
function fuzzyMatchAny(words, keywords) {
    const matched = [];
 ...
 */
function scoreIntent(tokens, messageBigrams, messageTrigrams, rawMessage, cluster) {
    let score = 0;
    const signals = [];
 ...
 */
function contextBoost(agent, conversationContext) {
